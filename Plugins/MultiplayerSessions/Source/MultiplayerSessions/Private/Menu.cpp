...
void UMenu::OnCreateSession(bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Green, FString(TEXT("Session Was created successfully!!")));
		}
...
void UMenu::JoinButtonClicked()
{
	...
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Cyan, FString(TEXT("Join Button Clicked")));
	}
}
