...
#include "FPS/Pickups/HealthPickup.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeHealthPickup() {}
// Cross Module References
	FPS_API UClass* Z_Construct_UClass_AHealthPickup_NoRegister();
...
// End Cross Module References
	...
	template<> FPS_API UClass* StaticClass<AHealthPickup>()
	{
		return AHealthPickup::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AHealthPickup);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_HealthPickup_h_Statics
	{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_HealthPickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AHealthPickup, AHealthPickup::StaticClass, TEXT("AHealthPickup"), &Z_Registration_Info_UClass_AHealthPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AHealthPickup), 3738646393U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_HealthPickup_h_840366596(TEXT("/Script/FPS"),
