...
// Cross Module References
	...
	FPS_API UClass* Z_Construct_UClass_UAnnouncement();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnnouncement_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "UI/Announcement.h" },
		{ "ModuleRelativePath", "UI/Announcement.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAnnouncement_Statics::NewProp_WarmupTime = { "WarmupTime", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnnouncement, WarmupTime), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnnouncement_Statics::NewProp_WarmupTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnnouncement_Statics::NewProp_WarmupTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAnnouncement_Statics::NewProp_InfoText = { "InfoText", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnnouncement, InfoText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnnouncement_Statics::NewProp_InfoText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnnouncement_Statics::NewProp_InfoText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAnnouncement_Statics::NewProp_AnnouncementText = { "AnnouncementText", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnnouncement, AnnouncementText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnnouncement_Statics::NewProp_AnnouncementText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnnouncement_Statics::NewProp_AnnouncementText_MetaData)) };
	...
	template<> FPS_API UClass* StaticClass<UAnnouncement>()
	{
		return UAnnouncement::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAnnouncement);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_UI_Announcement_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_UI_Announcement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnnouncement, UAnnouncement::StaticClass, TEXT("UAnnouncement"), &Z_Registration_Info_UClass_UAnnouncement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnnouncement), 319648647U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_UI_Announcement_h_2923119634(TEXT("/Script/FPS"),
		Z_CompiledInDeferFile_FID_FPS_Source_FPS_UI_Announcement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPS_Source_FPS_UI_Announcement_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
