...
#include "FPS/Weapons/Projectiles/ProjectileGrenade.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeProjectileGrenade() {}
// Cross Module References
	FPS_API UClass* Z_Construct_UClass_AProjectileGrenade_NoRegister();
	FPS_API UClass* Z_Construct_UClass_AProjectileGrenade();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Weapons/Projectiles/ProjectileGrenade.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectileGrenade_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectileGrenade_OnBounce, "OnBounce" }, // 3629005706
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectileGrenade_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Weapons/Projectiles/ProjectileGrenade.h" },
		{ "ModuleRelativePath", "Weapons/Projectiles/ProjectileGrenade.h" },
	};
#endif
#if WITH_METADATA
	...
	template<> FPS_API UClass* StaticClass<AProjectileGrenade>()
	{
		return AProjectileGrenade::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AProjectileGrenade);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_Projectiles_ProjectileGrenade_h_Statics
	{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_Projectiles_ProjectileGrenade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AProjectileGrenade, AProjectileGrenade::StaticClass, TEXT("AProjectileGrenade"), &Z_Registration_Info_UClass_AProjectileGrenade, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectileGrenade), 2235082222U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_Projectiles_ProjectileGrenade_h_3374832583(TEXT("/Script/FPS"),
