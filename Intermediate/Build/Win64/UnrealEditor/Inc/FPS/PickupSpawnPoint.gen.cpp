...
#include "FPS/Pickups/PickupSpawnPoint.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodePickupSpawnPoint() {}
// Cross Module References
	FPS_API UClass* Z_Construct_UClass_APickupSpawnPoint_NoRegister();
	FPS_API UClass* Z_Construct_UClass_APickupSpawnPoint();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APickupSpawnPoint_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APickupSpawnPoint_StartSpawnPickupTimer, "StartSpawnPickupTimer" }, // 1592343432
	};
#if WITH_METADATA
	...
	template<> FPS_API UClass* StaticClass<APickupSpawnPoint>()
	{
		return APickupSpawnPoint::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(APickupSpawnPoint);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_PickupSpawnPoint_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_PickupSpawnPoint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APickupSpawnPoint, APickupSpawnPoint::StaticClass, TEXT("APickupSpawnPoint"), &Z_Registration_Info_UClass_APickupSpawnPoint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APickupSpawnPoint), 759002209U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_PickupSpawnPoint_h_2809202760(TEXT("/Script/FPS"),
		Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_PickupSpawnPoint_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPS_Source_FPS_Pickups_PickupSpawnPoint_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
