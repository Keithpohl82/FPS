...
// Cross Module References
	...
	FPS_API UClass* Z_Construct_UClass_UInteractWithCrosshairsInterface();
...
// End Cross Module References
	...
	template<> FPS_API UClass* StaticClass<UInteractWithCrosshairsInterface>()
	{
		return UInteractWithCrosshairsInterface::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UInteractWithCrosshairsInterface);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_Interfaces_InteractWithCrosshairsInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Interfaces_InteractWithCrosshairsInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInteractWithCrosshairsInterface, UInteractWithCrosshairsInterface::StaticClass, TEXT("UInteractWithCrosshairsInterface"), &Z_Registration_Info_UClass_UInteractWithCrosshairsInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInteractWithCrosshairsInterface), 3718564808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Interfaces_InteractWithCrosshairsInterface_h_2614969634(TEXT("/Script/FPS"),
		Z_CompiledInDeferFile_FID_FPS_Source_FPS_Interfaces_InteractWithCrosshairsInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPS_Source_FPS_Interfaces_InteractWithCrosshairsInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
