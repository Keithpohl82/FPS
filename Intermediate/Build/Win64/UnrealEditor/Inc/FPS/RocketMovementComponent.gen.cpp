...
// Cross Module References
	...
	FPS_API UClass* Z_Construct_UClass_URocketMovementComponent();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URocketMovementComponent_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Weapons/RocketMovementComponent.h" },
		{ "ModuleRelativePath", "Weapons/RocketMovementComponent.h" },
	};
#endif
	...
	template<> FPS_API UClass* StaticClass<URocketMovementComponent>()
	{
		return URocketMovementComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(URocketMovementComponent);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_RocketMovementComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_RocketMovementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URocketMovementComponent, URocketMovementComponent::StaticClass, TEXT("URocketMovementComponent"), &Z_Registration_Info_UClass_URocketMovementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URocketMovementComponent), 2631526191U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_RocketMovementComponent_h_3299442802(TEXT("/Script/FPS"),
		Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_RocketMovementComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPS_Source_FPS_Weapons_RocketMovementComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
