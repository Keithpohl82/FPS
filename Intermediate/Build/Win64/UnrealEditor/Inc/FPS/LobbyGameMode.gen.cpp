...
#include "FPS/GameModes/LobbyGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLobbyGameMode() {}
// Cross Module References
	FPS_API UClass* Z_Construct_UClass_ALobbyGameMode_NoRegister();
	FPS_API UClass* Z_Construct_UClass_ALobbyGameMode();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALobbyGameMode_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "GameModes/LobbyGameMode.h" },
		{ "ModuleRelativePath", "GameModes/LobbyGameMode.h" },
	...
	template<> FPS_API UClass* StaticClass<ALobbyGameMode>()
	{
		return ALobbyGameMode::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALobbyGameMode);
	struct Z_CompiledInDeferFile_FID_FPS_Source_FPS_GameModes_LobbyGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_GameModes_LobbyGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALobbyGameMode, ALobbyGameMode::StaticClass, TEXT("ALobbyGameMode"), &Z_Registration_Info_UClass_ALobbyGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALobbyGameMode), 977785008U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FPS_Source_FPS_GameModes_LobbyGameMode_h_1654250040(TEXT("/Script/FPS"),
		Z_CompiledInDeferFile_FID_FPS_Source_FPS_GameModes_LobbyGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FPS_Source_FPS_GameModes_LobbyGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
